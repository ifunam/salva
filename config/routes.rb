Salva::Application.routes.draw do
  ...
  resources :user_languages, :user_skills, :user_schoolarships, :other_activities, :popular_science_activities, :institutional_activities
  ...
  catalog_resources_for :journals, :publishers, :institutions, :languages, :skilltypes, :schoolarships
  ...
  namespace :admin do
    ...
    super_catalog_for :cities, :states, :journals, :publishers, :adscriptions, :researchareas, 
                      ...
                      :contracttypes, :coursegrouptypes, :credittypes, :degrees
  end	
