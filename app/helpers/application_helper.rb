...
module ApplicationHelper
  ...
  def link_to_annual_report(user_id)
    ...
    elsif !@document_type.nil? and !AnnualReport.where(:user_id => user_id, :documenttype_id => @document_type.id, :delivered => false).first.nil?
      @annual_report = AnnualReport.where(:user_id => user_id, :documenttype_id => @document_type.id, :delivered => false).first
