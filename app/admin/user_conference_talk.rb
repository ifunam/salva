# encoding: utf-8
ActiveAdmin.register UserConferencetalk, :as => 'UserConferencetalk'  do
  ...
  index :title => 'Trabajos presentados en congresos' do
    ...
    column(:adscription) { |record| record.user.adscription_name record.user.id,record.conferencetalk.conference.year }
