class UserGenericwork  < ActiveRecord::Base
  ...
  named_scope :popularscienceworks, :joins => %Q( INNER JOIN genericworkgroups ON genericworkgroups.name = 'Productos de divulgación'  
  ...
  named_scope :find_by_popularsciencework_year, lambda { |y| 
                                      {
                                        :joins => %Q( INNER JOIN genericworkgroups ON genericworkgroups.name = 'Productos de divulgación'  
                                                  INNER JOIN genericworktypes ON genericworktypes.genericworkgroup_id = genericworkgroups.id 
                                                  INNER JOIN genericworks ON genericworks.id = user_genericworks.genericwork_id 
