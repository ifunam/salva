...
class AcademicprogramtypeTest < Test::Unit::TestCase
  ...
  def setup
   ...
   def test_check_uniqueness
     @academicprogramtypes = Academicprogramtype.new({:name => ' Escolarizado'})
     @academicprogramtypes.id= 2
     assert !@academicprogramtypes.save
   end
# boundary
# Checking constraints for name
  def test_bad_values_for_name
     ...
     @myacademicprogramtypes.name = 'X'
     assert !@myacademicprogramtypes.valid?

     @myacademicprogramtypes.name = 'X' * 201
     assert !@myacademicprogramtypes.valid?

     @myacademicprogramtypes.name = '5' 
     assert !@myacademicprogramtypes.valid?
  end
